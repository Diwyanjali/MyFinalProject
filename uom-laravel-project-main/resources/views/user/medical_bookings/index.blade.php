...
@section('title', 'Medical Bookings')
                                            ...
                                            @foreach ($bookings as $key => $booking)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @elseif ($booking->status == 'consulted')
                                                            <span class="badge text-bg-success">Doctor Consulted</span>
                                                        @else
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        @elseif($booking->status == 'consulted' || $booking->status == 'completed')
                                                            <a href="{{ route('user.bookings.medical.view', $booking->id) }}"
                                                                class="btn btn-outline-success btn-sm">View Prescription</a>
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
